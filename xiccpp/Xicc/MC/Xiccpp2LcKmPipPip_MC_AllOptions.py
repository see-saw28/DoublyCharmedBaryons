...
def Setup_options( the_year , polarity, evt_id, ganga=True ):
    ...
    if the_year == '2016':
        ...
        DaVinci().UserAlgorithms = [pi_proto, k_proto, seq0.sequence(), seq1.sequence(), seq2.sequence(), seq3.sequence()]#, seq4.sequence()] 
    
    DaVinci().InputType = 'MDST' 
    DaVinci().TupleFile = f'DV_Xiccpp_MC_{evt_id}_{the_year}_{polarity}.root' 
...
if test:            
    ...
    if evt_id == 26266050 :
        ...
        if the_year == '2016' :
            if polarity == 'MD':
                IOHelper().inputFiles(['/afs/cern.ch/work/p/pgaigne/DST/00137876_00000020_7.AllStreams.mdst'], clear=True)
            else :
                IOHelper().inputFiles(['/afs/cern.ch/work/p/pgaigne/DST/00071450_00000822_7.AllStreams.dst'], clear=True)
            #IOHelper().inputFiles(['/afs/cern.ch/work/p/pgaigne/DST/00071452_00000051_7.AllStreams.dst'], clear=True)
        elif the_year == '2018' :
            if polarity == 'MD':
                IOHelper().inputFiles(['/afs/cern.ch/work/p/pgaigne/DST/00138029_00000065_7.AllStreams.mdst'], clear=True)
            else :
                IOHelper().inputFiles(['/afs/cern.ch/work/p/pgaigne/DST/00071450_00000822_7.AllStreams.dst'], clear=True)

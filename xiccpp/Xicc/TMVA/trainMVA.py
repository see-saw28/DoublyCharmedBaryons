...
MCFile = ROOT.TFile("/eos/lhcb/user/p/pgaigne/MC/26266050/MC-2016-26266050.root")
# dataFile = ROOT.TFile("/eos/lhcb/user/p/pgaigne/job78-DV-Xiccpp-Collision-2017-MD-0.root")
dataFile = ROOT.TFile("/eos/lhcb/user/p/pgaigne/job74-DV-Xiccpp-Collision-2016-MD-0-reduced.root")
tree_s = MCFile.Get(f"tuple_sel_{tree}/DecayTree")
if tree == 'rec':
...
fout = ROOT.TFile(f"/afs/cern.ch/work/p/pgaigne/MVA/TMVAout-{tree}-SB.root","RECREATE")
...
loader = ROOT.TMVA.DataLoader(f"dataset-{tree}-SB")
...
if tree == 'rec' :
     ...
     loader.AddVariable("XiccPi1_PIDK","F")
     loader.AddVariable("XiccPi2_PIDK","F")
     ...
     loader.AddVariable("XiccPi1_PT","F")
     loader.AddVariable("XiccPi2_PT","F")
     ...
     loader.AddVariable("log(TMath::Max(10e-10,XiccPi1_IPCHI2_OWNPV))","log_XiccPi1_IPCHI2_OWNPV","","F")
     loader.AddVariable("log(TMath::Max(10e-10,XiccPi2_IPCHI2_OWNPV))","log_XiccPi2_IPCHI2_OWNPV","","F")
...
# 2016 cuts
sigCut = ROOT.TCut("abs(Xicc_M-3621)<15&(Lc_M>2270)&(Lc_M<2306)&XiccK_PIDK>-40") #mass window for Xicc

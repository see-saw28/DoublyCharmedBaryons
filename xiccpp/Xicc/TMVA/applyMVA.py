...
if tree=='Xicc':
     path = "/eos/lhcb/user/p/pgaigne/Collision-2016-MD-Xicc-job30.root"
     # path = "/eos/lhcb/user/p/pgaigne/Collision-2016-MU-Xicc-job38.root"

elif 'rec' in tree:
     # path = "/eos/lhcb/user/p/pgaigne/job30-CombDVntuple-95%-evts-1.root"
     #paths = ["/eos/lhcb/user/p/pgaigne/job78-DV-Xiccpp-Collision-2017-MD-0.root",
     #         "/eos/lhcb/user/p/pgaigne/job80-DV-Xiccpp-Collision-2017-MU-0.root"]#,
          #     "/eos/lhcb/user/p/pgaigne/job79-DV-Xiccpp-Collision-2018-MD-0.root",
          #     "/eos/lhcb/user/p/pgaigne/job81-DV-Xiccpp-Collision-2018-MU-0.root"] 

      paths = ["/eos/lhcb/user/p/pgaigne/Collision-2017-Xiccpp-job78-80-reduced.root"]
     #  paths = ["/eos/lhcb/user/p/pgaigne/Collision-2016-Xiccpp-job74-75-reduced.root"]
     #  paths = ["/eos/lhcb/user/p/pgaigne/Collision-2018-Xiccpp-job110-111-reduced.root"]
      #,
     ...
     #      #     "/eos/lhcb/user/p/pgaigne/job78-DV-Xiccpp-Collision-2017-MD-0.root",
     #      #     "/eos/lhcb/user/p/pgaigne/job79-DV-Xiccpp-Collision-2018-MD-0.root",
     #      #     "/eos/lhcb/user/p/pgaigne/job80-DV-Xiccpp-Collision-2017-MU-0.root",
     #      #     "/eos/lhcb/user/p/pgaigne/job81-DV-Xiccpp-Collision-2018-MU-0.root"]
...
for path in paths :
     ...
     if tree == 'Xicc':
          outputFilename = outputDir + name + '-MVA.root'
     elif tree == 'rec':
          outputFilename = outputDir + name + '-MVA.root'
     elif tree == 'rec-WS':
          outputFilename = outputDir + name + '-MVA-WS.root'
     elif tree == 'rec-SB':
          outputFilename = outputDir + name + '-MVA-SB.root'
     
     elif tree == 'rec-WS-17':
          outputFilename = outputDir + name + '-MVA-WS-17.root'
     ...
     if 'rec' in tree :
          ...
          reader.AddVariable("log(Xicc_IPCHI2_OWNPV)", rlog_Xicc_IPCHI2_OWNPV)
          reader.AddVariable("TMath::ACos(Xicc_DIRA_OWNPV)",racos_Xicc_DIRA_OWNPV)
          reader.AddVariable("log(Xicc_FDCHI2_OWNPV)",rlog_Xicc_FDCHI2_OWNPV)
          reader.AddVariable("Lc_ENDVERTEX_CHI2/Lc_ENDVERTEX_NDOF",rLc_ENDVERTEX_CHI2_NDOF)
          reader.AddVariable("Xicc_ENDVERTEX_CHI2/Xicc_ENDVERTEX_NDOF",rXicc_ENDVERTEX_CHI2_NDOF)
          reader.AddVariable("Xicc_CHI2NDOF_DTF_PV",rXicc_CHI2NDOF_DTF_PV)
          reader.AddVariable("log(TMath::Max(10e-10,TMath::Min(TMath::Min(Lc_IPCHI2_OWNPV,XiccK_IPCHI2_OWNPV),TMath::Min(XiccPi1_IPCHI2_OWNPV,XiccPi2_IPCHI2_OWNPV))))",rminlog_IPCHI2)
          reader.AddVariable("XiccK_PT + Lc_PT + XiccPi1_PT + XiccPi2_PT",rsumPT)
          reader.AddVariable("TMath::Min(TMath::Min(XiccK_PT,Lc_PT),TMath::Min(XiccPi1_PT,XiccPi2_PT))",rminPT)
          reader.AddVariable("TMath::Min(TMath::Min(LcK_PT,LcPi_PT),LcP_PT)",rminPT_Lc)
     ...
     reader.BookMVA("BDT", f"dataset-{tree}/weights/TMVAClassification_BDT.weights.xml")
     ...
     if tree == 'Xicc':
          ...
          outTree.Branch("log_min_Xicc_Daughters_IPCHI2_OWNPV", rminlog_IPCHI2, "log_min_Xicc_Daughters_IPCHI2_OWNPV/F")
          ...
          outTree.Branch("min_Lc_Daughters_PT", rminPT_Lc, "min_Lc_Daughters_PT/F")

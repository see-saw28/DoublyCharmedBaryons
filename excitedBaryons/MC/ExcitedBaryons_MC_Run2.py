...
if the_year == '2016':
    ...
    Pions = FilterSelection("pi", [AutomaticData("Phys/TurboAllNoPIDsPions/Particles")], Code="(P>1*GeV) & (PT>150*MeV) & (MIPCHI2DV(PRIMARY)>1) & (PROBNNpi>0.05)")

    k_proto = NoPIDsParticleMaker("TurboAllNoPIDsKaons", Particle="kaon", Input="Long/Protos")
    Kaons = FilterSelection("kaon", [AutomaticData("Phys/TurboAllNoPIDsKaons/Particles")], Code="(P>1*GeV) & (PT>150*MeV) & (MIPCHI2DV(PRIMARY)>1) & (PROBNNk>0.05)")
...
if the_year != '2016':
    DaVinci().UserAlgorithms = [pi_proto, k_proto]

...
# years = [2016]
polarities = ['MD','MU']
evt_types = [26167051,26167052,26167053,26167054,26167055,26167056]
# evt_types = [26167054]#,26167055,26167056]
...
for evt_type in evt_types:
    for the_year in years:
        for polarity in polarities:
            ...
            j.application = myApp
            j.application.options = ['ExcitedBaryons_MC_Run2_AllOptions.py']
            j.application.extraOpts = (
                        "import sys, os\n"
                        "sys.path.append(os.getcwd())\n"
                        "from ExcitedBaryons_MC_Run2_AllOptions import Setup_options\n"

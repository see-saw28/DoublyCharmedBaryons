...
void bkgFitOmega(){
  ...
  TString filepath_Run2 = "/eos/lhcb/user/p/pgaigne/STEP3/Run2/Omegaccpst-WS-Run2-Lc-Loose-clone-duplicate-Loose-MVA-delta.root";
...
// plot minimal value fit
  ...
  bkgmodel.paramOn(mframe, Layout(0.55, 0.90, 0.88));
  ...
  c1_Data->SaveAs("XiccK_Bkg_fit_WS.pdf");

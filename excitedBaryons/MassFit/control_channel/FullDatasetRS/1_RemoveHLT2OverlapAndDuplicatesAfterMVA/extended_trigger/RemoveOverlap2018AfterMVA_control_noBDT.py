...
out_file = open("OverlapDuplicatesRemoval_controlRS_2018_noBDT.txt","w+")
...
cut = "Xic_M > 2450 & Xic_M < 2488 & DM > 3500 & DM < 3800 & PPi_angle > 0.0005 & PPi1_angle > 0.0005 & PiPi1_angle > 0.0005 & PK_angle > 0.0005 & KPi_angle > 0.0005 & KPi1_angle > 0.0005 & MVA_MLP > 0.96"
...
merged_df = pd.concat([bkg_df_2018_incl, bkg_df_2018_excl], axis = 0, sort=True)
...
merged_df.to_root(("/nfs/users/dbobulska/Xiccp_studies/2018/Data/control_channel_XicpPip/RS_full_dataset/TMVAoutput/"
                  "Data_2018_Xicc_TMVAapplication_allMVAmethods_moreBranches_OverlapRemoved_afterMVA_MLP096_noBDT.root"),
                  key="DecayTree")

...
*/
 ...
 sData->GetSDataSet()->write("weights_allHLT2line.out");
 printf("!!! number of entries: %f \n", sData->GetSDataSet()->sumEntries() );
 //ws->writeToFile("ws.root");

}

void FitGaussDSCBcontrolNewAll(){

  lhcbStyle();

  TFile *myfile2016 = new TFile("/nfs/users/dbobulska/Xiccp_studies/2016/Data/control_channel_XicpPip/RS_full_dataset/TMVAoutput/Data_2016_Xicc_TMVAapplication_allMVAmethods_moreBranches_OverlapRemoved_afterMVA_MLP096.root","READ");
  TFile *myfile2017 = new TFile("/nfs/users/dbobulska/Xiccp_studies/2017/Data/control_channel_XicpPip/RS_full_dataset/TMVAoutput/Data_2017_Xicc_TMVAapplication_allMVAmethods_moreBranches_OverlapRemoved_afterMVA_MLP096.root","READ");
  TFile *myfile2018 = new TFile("/nfs/users/dbobulska/Xiccp_studies/2018/Data/control_channel_XicpPip/RS_full_dataset/TMVAoutput/Data_2018_Xicc_TMVAapplication_allMVAmethods_moreBranches_OverlapRemoved_afterMVA_MLP096.root","READ");
  ...
  TCut selection = "Xic_M > 2450. && Xic_M < 2488. && MVA_MLP > 0.975 && PPi_angle > 0.0005 & PPi1_angle > 0.0005 & PiPi1_angle > 0.0005 & PK_angle > 0.0005 & KPi_angle > 0.0005 & KPi1_angle > 0.0005 && "
  ...
  TFile *newfile = new TFile("temp_all.root","RECREATE");
  ...
  model.plotOn(xframe,Name("bkgmodel"),Components("bkg"),LineStyle(kDashed),LineColor(kGreen));
...
*/
  ...
  leg->AddEntry(xframe->findObject("signalmodel"),"DSCB+Gaussian","L");
  leg->AddEntry(xframe->findObject("bkgmodel"),"Expo","L");
  ...
  xframe->GetYaxis()->SetRangeUser(0,500);
...
*/
  ...
  //xframe->Draw();
  c->SaveAs("Xiccpp_GaussDSCB_RSdata_combined_AllLines.pdf");

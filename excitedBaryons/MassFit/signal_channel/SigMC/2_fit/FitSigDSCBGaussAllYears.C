...
void FitSigDSCBGaussAllYears(){
  ...
  TTree *newtree2016n = mytree2016n->CopyTree(selection);
  TTree *newtree2016r = mytree2016r->CopyTree(selection);
  ...
  model.fitTo(data,SumW2Error(kTRUE),RooFit::PrintLevel(-1));
...
*/
  ...
  xframe->GetYaxis()->SetRangeUser(0.,6100.);
  ...
  c->SaveAs("Xiccp_GaussDSCB_MC_combined_L0TIS.pdf");

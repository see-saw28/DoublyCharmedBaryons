...
void ExpoFitCombinedAllLines(){

  lhcbStyle();

  TString filepath_2016 = "/nfs/users/dbobulska/Xiccp_studies/2016/Data/signal_channel/WSM/TMVAoutput/Data_2016_Xicc_WSM_TMVAapplication_allMVAmethods_moreBranches_OverlapRemoved_afterMVA_MLP.root";
  TString filepath_2017 = "/nfs/users/dbobulska/Xiccp_studies/2017/Data/signal_channel/WSM/TMVAoutput/Data_2017_Xicc_WSM_TMVAapplication_allMVAmethods_moreBranches_OverlapRemoved_afterMVA_MLP.root";
  TString filepath_2018 = "/nfs/users/dbobulska/Xiccp_studies/2018/Data/signal_channel/WSM/TMVAoutput/Data_2018_Xicc_WSM_TMVAapplication_allMVAmethods_moreBranches_OverlapRemoved_afterMVA_MLP.root";
  ...
  TCut selection = "Xic_M > 2450. && Xic_M < 2488. && MVA_MLP > 0.88 && PK_angle > 0.0005 && PPi_angle > 0.0005 && PPi1_angle > 0.0005 && "
...
*/
  ...
  xframe->GetYaxis()->SetRangeUser(0.,1500);
...
RooHist* hresid = xframe->pullHist() ;
  ...
  c->SaveAs("Expo_bkg_WSM_combined_allHLT2Lines.pdf");

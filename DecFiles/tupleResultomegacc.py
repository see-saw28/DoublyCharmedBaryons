...
decay = "[Omega_cc+ => ^(Xi_cc++ => ^(Lambda_c+ => ^p+ ^K- ^pi+) ^K- ^pi+ ^pi+) ^K- ]CC"
decay_heads = ["Omega_cc+", "Omega_cc~-"]
datafile = "Gauss-26167073-100ev-20230302.xgen"
year = 2016
...
# Configure DaVinci
DaVinci().TupleFile = "DVntupleOmegacc_26167073.root"
